...
public class ProdutoApiController {
	...
	public ResponseEntity<?> criarProduto(@RequestBody ProdutoDoCarrinhoDTO produtoDTO, UriComponentsBuilder ucBuilder) {

		List<Produto> produtos = produtoService.getProdutoByCodigoBarra(produtoDTO.getProduto().getCodigoBarra());
	...
	public ResponseEntity<?> atualizarProduto(@PathVariable("id") long id, @RequestBody ProdutoDoCarrinhoDTO produtoDTO) {
